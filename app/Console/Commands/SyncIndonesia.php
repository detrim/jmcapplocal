...
class SyncIndonesia extends Command
{
    protected $signature = 'app:sync-indonesia';
    ...
    public function handle()
    {
        ...
        Storage::put('wilayah/kecamatan.json', json_encode($result['kecamatan']));
        Storage::put('wilayah/kabupaten.json', json_encode($result['kabupaten']));
        Storage::put('wilayah/provinsi.json', json_encode($result['provinsi']));
